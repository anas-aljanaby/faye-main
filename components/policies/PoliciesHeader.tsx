...
const confidential = 'سري - للاستخدام الداخلي';
    ...
    <header className="bg-bg-card border-b border-gray-200 shadow-sm print:border-0">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-5">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <p className="text-primary text-sm font-medium mb-1">بِسْمِ اللهِ الرَّحْمَنِ الرَّحِيمِ</p>
            <h1 className="text-2xl md:text-3xl font-bold text-primary leading-tight">
              جمعية فيء لرعاية الأيتام
            </h1>
            <p className="text-base md:text-lg text-text-secondary mt-0.5">Fay&apos; Association for Orphan Care</p>
            <p className="text-lg md:text-xl font-semibold text-text-primary mt-4">دليل السياسات المؤسسية</p>
            <p className="text-text-secondary mt-0.5 text-sm md:text-base">دليل السياسات المؤسسية الشاملة</p>
