              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      {countsLoading ? <div className="h-8 w-10 bg-gray-200 animate-pulse rounded mb-1" /> : <p className="text-2xl font-bold text-gray-800">{orphansData.length}</p>}
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      {countsLoading ? <div className="h-8 w-10 bg-gray-200 animate-pulse rounded mb-1" /> : <p className="text-2xl font-bold text-gray-800">{sponsorsData.length}</p>}
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      {countsLoading ? <div className="h-8 w-10 bg-gray-200 animate-pulse rounded mb-1" /> : <p className="text-2xl font-bold text-gray-800">{duePayments}</p>}
                      <p className="text-sm text-text-secondary">دفعة مستحقة</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-white/50">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      {countsLoading ? <div className="h-8 w-10 bg-gray-200 animate-pulse rounded mb-1" /> : <p className={`text-2xl font-bold ${overduePayments > 0 ? 'text-red-600' : 'text-gray-800'}`}>{overduePayments}</p>}
                      <p className="text-sm text-text-secondary">دفعة متأخرة</p>
                    </div>
                  </div>
                </div>
